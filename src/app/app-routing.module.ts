...
const routes: Routes = [
  ...
  {path: 'teachers/assignment/:asnID', component: TeachersAssignmentComponent, canActivate: [StudentAuthGuard]},
  {path: 'students/home', component: TeachersHomepageComponent, canActivate: [TeacherAuthGuard]},
